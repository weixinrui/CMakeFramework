...
MACRO(SET_TARGET_CONFIG_DEFINITIONS _TARGET_NAME _TARGET_NAME)
    ...
    FOREACH(i RANGE ${_LIST_LEN})
        ...
        SET(_CONFIG_ITEM "$<$<CONFIG:${_CONFIG}>:${_${TARGET_TYPE}_DEFINITIONS_${_CONFIG}}>")
...
ENDMACRO(SET_TARGET_CONFIG_DEFINITIONS _TARGET_NAME _TARGET_NAME)
